...
def email(loc):
        ...
        but_2=CTkButton(em,text='Exit',fg_color='black',text_color="white",text_font=('bold',20),corner_radius=8,hover_color="#545352",command=quit).place(relx=0.75,y=350,anchor='center')
...
def en_successful(loc):
        ...
        suc.title('Encryption Successful')
        ...
        but_1=CTkButton(suc,text='Exit',fg_color='black',text_color="white",text_font=('bold',20),corner_radius=8,hover_color="#545352",command=quit).place(relx=0.75,y=150,anchor='center')
...
def successful():
        ...
        lab_1=CTkLabel(suc,text='Successful',fg_color=None,text_color="white",text_font=('bold',40)).place(relx=0.5,y=75,anchor='center')
...
def main():
    ...
    but_5=CTkButton(main,text='Exit',fg_color='black',text_color="white",text_font=('bold',20),corner_radius=8,hover_color="#545352",command=quit).place(relx=0.5,y=450,anchor='center')
    main.mainloop()
